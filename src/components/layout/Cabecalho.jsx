                ...
                <nav css={cabecalhoFundo}>
                    <ul css={cabecalhoLista}>
                        ...
                        <div css={logosCabecalho}>
                            <li css={cabecalhoItem}>
                                <Link css={cabecalhoLink} to={"https://github.com/AndWilli23"} target="_blank"  rel="noopener noreferrer" aria-label="Perfil do GitHub">
                                    <img css={logoCabecalhoGit} src={github} alt="botão com logo do github"/>
                                </Link>
                            </li>

                            <li css={cabecalhoItem}>
                                <Link css={cabecalhoLink} to={"https://www.linkedin.com/in/anderson-willian-b81b18274/"} target="_blank" rel="noopener noreferrer" aria-label="Perfil do Linkedin">
